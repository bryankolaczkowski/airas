...
for protein in proteins:
    ...
    # set phylogenetic distances #
    blen = float(protein.split("_")[0][1:])
    root_dists = { "6":(blen,blen,1) }

    # read in errors #
    results = {}

    handle = open("err_reports_02/%s.origErrors.csv" % protein, "r")
    handle.readline()
    for line in handle:
    ...
    # print results #
    outf = open("err_reports_03/%s.compiledErrors.csv" % protein, "w")
